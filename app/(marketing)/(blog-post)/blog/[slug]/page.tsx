    ...
    <>
      <MaxWidthWrapper className="pt-6 md:pt-10">
        <div className="flex flex-col space-y-4">
          ...
          <h1 className="text-3xl text-foreground sm:text-4xl">{post.title}</h1>
      ...
      <MaxWidthWrapper>
        {relatedArticles.length > 0 && (
          <div className="flex flex-col space-y-4 pb-16">
            <p className="text-2xl text-foreground">More Articles</p>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:gap-6">
              {relatedArticles.map((post) => (
                ...
                >
                  <h3 className="text-xl text-foreground">{post.title}</h3>
