    ...
    <>
      <section className="overflow-hidden pb-24 pt-12 sm:pb-32 sm:pt-20">
        <MaxWidthWrapper large>
          ...
          <div className="mt-14 grid gap-10 border-t border-[var(--site-line)] pt-10 md:grid-cols-2">
            <ArrowDownRight
              aria-hidden="true"
              className="size-14 text-[var(--site-muted)]"
            />
            <div className="space-y-6 text-xl leading-relaxed text-[var(--site-muted)] sm:text-2xl">
              <p>
      ...
      <section className="pb-28 sm:pb-36" aria-labelledby="identity-heading">
        <MaxWidthWrapper large>
          <div className="overflow-hidden rounded-2xl border border-[var(--site-line)] bg-[var(--site-surface)]">
            <div className="grid gap-6 border-b border-[var(--site-line)] p-7 sm:p-10 md:grid-cols-2">
              <h2
                id="identity-heading"
              ...
              <p className="max-w-lg text-lg leading-relaxed text-[var(--site-muted)]">
            ...
            <dl>
              {facts.map(([term, detail]) => (
                <div
                  key={term}
                  className="grid gap-3 border-b border-[var(--site-line)] px-7 py-7 last:border-b-0 sm:px-10 md:grid-cols-[0.4fr_1fr]"
                >
      ...
      <section className="pb-28 sm:pb-36">
        <MaxWidthWrapper>
          <div className="grid gap-10 rounded-2xl border border-[var(--site-line)] bg-[var(--site-surface-raised)] p-8 sm:p-12 md:grid-cols-[1fr_auto] md:items-end">
            <div>
